...
export class BranchFormService {
  ...
  xxxmdcsChecker: FormlyFieldConfig[] = [
    {
      fieldGroupClassName: 'display-flex',
      fieldGroup: [
        {
  ...
  */
  ...
  verifyCustomerOwnership(id) {
    return this._http.get(ApiConstants.branchApi + '/validateSinglePropOwnership/' + id);
  }
